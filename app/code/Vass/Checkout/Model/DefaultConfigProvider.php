...
class DefaultConfigProvider extends \Magento\Checkout\Model\DefaultConfigProvider
{
    ...
    public function __construct(
        ...
        \Vass\Checkout\Helper\Data $helperCheckout,
    ...
    public function getConfig()
    {
        ...
        $output['textSummaryCustom'] = $this->helperCheckout->getTextSummary();
        $output['textOrdenNumber'] = "20000400103031";
