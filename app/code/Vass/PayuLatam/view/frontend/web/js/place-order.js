define([
	...
	'Vass_PayuLatam/js/view/payment/form-builder',
	'Magento_Checkout/js/model/error-processor'
], function ($, url, customerData, formBuilder, errorProcessor) {
	'use strict';
	...
	return {
		...
		placeOrder: function (firstPayment = null) {
			let address, offerPrice = firstPayment ?? this.productData.offer_price;
			...
			$.ajax({
				method: 'POST',
				url: url.build('payulatam/payment/order'),
				dataType: 'json',
				data: payload
			})
