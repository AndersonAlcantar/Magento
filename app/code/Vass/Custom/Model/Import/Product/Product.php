...
class Product extends \Magento\CatalogImportExport\Model\Import\Product
{
    ...
    protected $_messageTemplates = [
        ...
        ValidatorInterface::ERROR_INVALID_WEBSITE => 'Invalid value in the "Website" column (does the website exist?)',
        ValidatorInterface::ERROR_INVALID_STORE => 'Invalid value in column "Store" (does the store exist?)',
        ValidatorInterface::ERROR_INVALID_ATTR_SET => 'Invalid value for "Attribute Set" column (does the set value exist?)',
    ...
    public function __construct(
        ...
        parent::__construct(
            $jsonHelper, $importExportData, $importData, $config, $resource, $resourceHelper, $string, $errorAggregator,$eventManager,
            $stockRegistry, $stockConfiguration, $stockStateProvider, $catalogData, $importConfig,$resourceFactory,$optionFactory,$setColFactory,
            $productTypeFactory, $linkFactory, $proxyProdFactory, $uploaderFactory,$filesystem,$stockResItemFac,$localeDate,$dateTime,
            $logger,$indexerRegistry,$storeResolver,$skuProcessor,$categoryProcessor,$validator,$objectRelationProcessor,$transactionManager,
            $taxClassProcessor,$scopeConfig,$productUrl,$data,$dateAttrCodes, $catalogConfig, $imageTypeProcessor, $mediaProcessor, 
            $stockItemImporter, $dateTimeFactory, $productRepository, $statusProcessor, $stockProcessor, $linkProcessor, $fileDriver
        );
    ...
    {
        if (!$this->validator->isAttributeValid($attrCode, $attrParams, $rowData, $rowNum)) {
