...
namespace Vass\Custom\CustomerData;
...
class DefaultItem extends \Magento\Checkout\CustomerData\DefaultItem
{
    ...
    public function __construct(
        ...
        \Vass\Custom\Helper\Data $customHelper
    ) {
    ...
    protected function doGetItemData()
    {
        ...
        $attributeSetName = $this->customHelper->getAttributeSetName($this->item->getProduct()->getAttributeSetId());
