 ...
 */
namespace Vass\Custom\Controller\Checkout\Cart;
...
class Add extends \Magento\Checkout\Controller\Cart\Add
{
    ...
    public function execute()
    {
        ...
        if($params["typePurchase"] == "store"){
            $checkAvailability = $this->service->getCheckAvailability($params["sku"], $params['idWareHouse']);
            $stock = $checkAvailability["amountInventory"];
            if($stock == 0){
                $this->messageManager->addErrorMessage(
