    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            try {
                ...
                if(empty($id))
                {
                    $this->messageManager->addSuccessMessage(__('Offert Cross-selling Created.'));
                }elseif(!empty($id)){
                    $this->messageManager->addSuccessMessage(__('Offert Cross-selling Edited .'));
                }
                ...
                $this->messageManager->addExceptionMessage($e, __('An error occurred while saving Offert Cross-selling.'));
            }
