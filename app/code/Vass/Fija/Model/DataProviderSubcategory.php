...
use Vass\Fija\Model\ResourceModel\Subcategory\CollectionFactory;
use \Magento\Store\Model\StoreManagerInterface;
 
class DataProviderSubcategory extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    protected $request;
     /**
        ...
        if ( !empty($catId) ) {
            ...
            foreach ($items as $item) {
                ...
                if ($blogData['image']) {
                    ...
                    $blogData['image'][0]['url'] = $mediaUrl."image/subcategory/".$blogImage; 
                }
                $this->loadedData[$item->getId()] = $blogData;    
            }
            return $this->loadedData;
